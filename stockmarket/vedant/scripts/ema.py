...
tv = TvDatafeed()  # TvDatafeed(username='your_email', password='your_pass') for logged-in access
data = tv.get_hist(
    symbol='AAPL',
    exchange='NASDAQ',
    interval=Interval.in_1_minute,
    n_bars=500          # increase as needed (max ~5000 for 1m)
)
...
# ── Plotly Chart: Candlestick + EMA lines + Crossover markers ──
